@garden_1 = Garden.create!(name: "Turing Community Garden", organic: true)
  ...
  @plant_5 = Plant.create!(name: "Cherry Tomato", description: "You'll have way too many of them to know what to do with", days_to_harvest: 65)
  @plant_6 = Plant.create!(name: "Cucumber", description: "Delightful on a sandwich", days_to_harvest: 70)
  @plant_7 = Plant.create!(name: "Butternut Squash", description: "MY CABBAGES", days_to_harvest: 130)
  @plant_8 = Plant.create!(name: "Radish", description: "It's a radish", days_to_harvest: 120)
  @plant_9 = Plant.create!(name: "Onion", description: "I'm not crying, you're crying", days_to_harvest: 80)
  @plant_10 = Plant.create!(name: "String Bean", description: "Eat them fresh from the vine", days_to_harvest: 30)
  ...
  PlantPlot.create!(plot_id: @plot_1.id, plant_id: @plant_8.id)
  PlantPlot.create!(plot_id: @plot_1.id, plant_id: @plant_7.id)
  PlantPlot.create!(plot_id: @plot_2.id, plant_id: @plant_1.id)
  PlantPlot.create!(plot_id: @plot_2.id, plant_id: @plant_10.id)